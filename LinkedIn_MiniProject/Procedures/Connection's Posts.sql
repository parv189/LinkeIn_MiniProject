...
select DISTINCT uc.UserConnection_Id, uc.User_ID, uc.ConnectedUser_ID, up.Post_Id, up.Photo_Url, up.content, up.CreatedById, up.CreatedByDate,ui.FirstName, ui.LastName, ui.User_Profile_photo,
 COUNT(pl.User_Id)as LikeCounts,case when(1=1) then 'notLiked' end as Status  from UserConnections uc 
...
group by uc.UserConnection_Id,uc.User_ID,uc.ConnectedUser_ID,up.Post_Id,up.Photo_Url,up.content,up.CreatedById,up.CreatedByDate,ui.FirstName,ui.LastName,ui.User_Profile_photo,pl.PostLike_Id,pl.User_Id
...
as 
select DISTINCT uc.UserConnection_Id, uc.User_ID, uc.ConnectedUser_ID, up.Post_Id, up.Photo_Url, up.content, up.CreatedById, up.CreatedByDate,ui.FirstName, ui.LastName, ui.User_Profile_photo,
COUNT(pl.User_Id)as LikeCounts, 
...
as
select DISTINCT up.Post_Id, up.Photo_Url, up.content, up.CreatedByDate,ui.FirstName, ui.LastName, ui.User_Profile_photo, ui.User_ID, COUNT(pl.Post_Id)as LikeCounts,
